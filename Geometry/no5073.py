...
while True:
    sides = []
    side_01, side_02, side_03 = map(int, input("세 변 입력: ").split())
    
    if side_01 == side_02 == side_03 == 0:
        break
    
    sides.append(side_01)
    sides.append(side_02)
    sides.append(side_03)
    
    eval_side = len(set(sides))
