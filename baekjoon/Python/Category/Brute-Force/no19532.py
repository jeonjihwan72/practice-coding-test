...
원본 링크 : https://www.acmicpc.net/problem/19532
'''
...
문제에서 언급한 방정식을 만족하는 (x,y)가 유일하게 존재하고, 이 때 x와 y가 각각 -999이상 999이하의 정수인 경우만 입려긍로 주어짐이 보장된다.
'''
...
a,b,c,d,e,f = map(int, input("a,b,c,d,e,f: ").split())
